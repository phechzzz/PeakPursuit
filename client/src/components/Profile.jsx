    ...
    <>
      <article className="flex max-w-xl flex-col items-center justify-between">
        <div className="group relative">
          ...
          <div className="flex justify-center">
            <img className="h-20 w-20 flex-none rounded-full bg-gray-50" src='https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80' alt="" /> {/* Increased profile pic size */}
          </div>
